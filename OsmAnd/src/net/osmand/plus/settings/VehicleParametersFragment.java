...
public class VehicleParametersFragment extends BaseSettingsFragment {
	...
	protected void setupPreferences() {
		...
		vehicleParametersInfo.setTitle(getString(R.string.vehicle_parameters_info, selectedAppMode.toHumanString(getContext())));
	...
	private void setupCustomRoutingPropertyPref(GeneralRouter.RoutingParameter parameter) {
		...
		listPreference.setKey(pref.getId());
		listPreference.setEntries(parameter.getPossibleValueDescriptions());
		listPreference.setEntryValues(valuesStr);
		listPreference.setTitle(title);
		listPreference.setDescription(description);
		listPreference.setIcon(getPreferenceIcon(parameterId));
		listPreference.setLayoutResource(R.layout.preference_with_descr);
